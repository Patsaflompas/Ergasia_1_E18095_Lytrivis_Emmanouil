...
def add_courses():
    ...
    if student != None:
        ...
        student = students.find_one({"email":data['email']},{"_id":0}) #den mou emfanize alliws ta nea stoixeia, meta to courses,ektos an o xrhsths ksanaestelne request, opote epanalambanw to find one query
